...
Example focus: reversible computing.

Use this folder as a complete Bifocal research workspace for studying reversible computing, including reversible logic, Landauer's principle, thermodynamic limits of computation, adiabatic computing, quantum computing connections, and practical hardware or software approaches. Add papers, book notes, lecture notes, or copied excerpts to `sources/`, then run Bifocal from this folder.
