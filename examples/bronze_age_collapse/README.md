...
Use this folder as a complete Bifocal research workspace for studying the collapse of Late Bronze Age societies in the eastern Mediterranean and Near East. Add papers, book notes, excavation reports, climate studies, primary texts, or copied excerpts to `sources/`, then run Bifocal from this folder.
