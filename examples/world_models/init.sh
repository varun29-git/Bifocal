...
mkdir -p "$TARGET/.agent" "$TARGET/sources" "$TARGET/quick_notes" "$TARGET/my_wikipedia" "$TARGET/deep_insights" "$TARGET/examples"
...
cat > "$TARGET/examples/README.md" <<'EOF_EXAMPLES_README'
# Examples

This folder holds sample Bifocal projects, source sets, or walkthroughs.

Use it to show how `sources/`, `quick_notes/`, `my_wikipedia/`, `radar.md`, and `deep_insights/` look after a real run.
EOF_EXAMPLES_README
