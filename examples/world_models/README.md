...
Example focus: world models.

Use this folder as a complete Bifocal research workspace for studying world models. Add papers, notes, links, or copied excerpts to `sources/`, then run Bifocal from this folder.
